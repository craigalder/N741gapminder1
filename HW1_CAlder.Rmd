...
### Answer to Homework 01 Exercise - Task 1

The mean life expectancy in the sample is `r round(mean(gapminder$lifeExp),digits=2)`, the standard deviation `r round(sd(gapminder$lifeExp),digits=2)`, the median `r round(median(gapminder$lifeExp),digits=2)`, and the sample size `r round(length(gapminder$lifeExp), digits=2)`.
...
### Answer to Homework 01 Exercise - Task 4

Bubble plot for Americas and Asia in the year 1992.
...
The link to my Github repository used for this assignment is located at [https://github.com/craigalder/N741gapminder1.git](https://github.com/craigalder/N741gapminder1.git).
